...
uploaded_file = st.file_uploader("Firearm Injury Death by Year, New Mexico and U.S.csv", type=["csv"])
...
if uploaded_file is not None:
    ...
    x_column = st.selectbox("Year ", columns)
    y_column = st.selectbox("Deaths per year 100,000", columns)
